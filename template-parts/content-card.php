...
$summary          = mumega_motion_card_summary( $card_post );
...
<article class="content-card">
	<?php if ( has_post_thumbnail( $card_post ) ) : ?>
		<a class="content-card__media" href="<?php echo esc_url( get_permalink( $card_post ) ); ?>" tabindex="-1" aria-hidden="true">
			<?php
