...
ASTER is MCPWP's single public synthetic editorial guide. ASTER may introduce briefings, explain research context, and provide a consistent visual or voice layer. ASTER is not a human author, technical verifier, or publication authority.

Internal agents are operational roles and do not become public bylines. Service-account names and API usernames are not polished public author identities.
